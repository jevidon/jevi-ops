-- ─────────────────────────────────────────────────────────────────────────
-- Jerad Dashboard — consolidated Supabase schema
-- ─────────────────────────────────────────────────────────────────────────
--
-- Snapshot of the schema after migrations 0001..0030. Safe to run ONCE
...
--      app_settings (America/Denver), and health_history (singleton).
--
-- What it does NOT do:
...
declare
  ...
  policy_tables text[] := array[
    ...
    'notifications','observations','action_log','email_rules',
